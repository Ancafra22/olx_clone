...
import com.andrefrancisco.olxclone.api.CEPService;
import com.andrefrancisco.olxclone.helper.FirebaseHelper;
import com.andrefrancisco.olxclone.helper.GetMask;
import com.andrefrancisco.olxclone.model.Anuncio;
import com.andrefrancisco.olxclone.model.Categoria;
import com.andrefrancisco.olxclone.model.Endereco;
import com.andrefrancisco.olxclone.model.ImagemUpload;
...
public class FormAnuncioActivity extends AppCompatActivity {
    ...
    public void validaDadosForm(View view) {
    ...
    private void dispatchTakePictureIntent(int requestCode) {
        ...
        if (photoFile != null) {
            Uri photoURI = FileProvider.getUriForFile(this,
                    "com.andrefrancisco.olxclone.fileprovider",
                    photoFile);
